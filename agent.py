...
# summarization_model = init_chat_model(model="gemini-2.5-flash-lite")
...
# research_brief =  """Search for datasets and pre-trained models relevant to predictive maintenance in heavy industries, 
# particularly steel factories and rolling mills. Focus on vibration data, acoustic emission, thermal readings, 
# and sensor data from industrial machinery. Platforms to prioritize: Kaggle, HuggingFace, and GitHub. 
# Return up to 10 relevant datasets/models with title, description, size, license, and direct link.
# """
